...
export const ChatHeader = ({ chat, accountId, onScrollToMessage }: ChatHeaderProps) => {
              ...
              <div style={{ position: 'relative' }} ref={menuRef}>
                ...
                {showMenu && (
                  <div className="chat-options-menu">
                    <button className="chat-options-menu-item" onClick={() => { toggleSearch(); }}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                      Search
                    </button>
                    <button className="chat-options-menu-item" onClick={() => setShowMenu(false)}>
                    ...
                    <button className="chat-options-menu-item danger" onClick={() => setShowMenu(false)}>
